...
namespace Abzal_s {
    ...
    public partial class StudentsDataSet : global::System.Data.DataSet {
        ...
        public partial class tableDataTable : global::System.Data.TypedTableBase<tableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tableRow AddtableRow(string Имя, string Язык, int Возраст, string Категория) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tableRow FindByИмя(string Имя) {
        ...
        public partial class tableRow : global::System.Data.DataRow {
            ...
            public string Язык {
                get {
                    try {
                        return ((string)(this[this.tabletable.ЯзыкColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Язык\' в таблице \'table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tabletable.ЯзыкColumn] = value;
                }
            }
            ...
            public int Возраст {
                get {
                    try {
                        return ((int)(this[this.tabletable.ВозрастColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Возраст\' в таблице \'table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tabletable.ВозрастColumn] = value;
                }
            }
            ...
            public bool IsЯзыкNull() {
                return this.IsNull(this.tabletable.ЯзыкColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetЯзыкNull() {
                this[this.tabletable.ЯзыкColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsВозрастNull() {
                return this.IsNull(this.tabletable.ВозрастColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetВозрастNull() {
                this[this.tabletable.ВозрастColumn] = global::System.Convert.DBNull;
            }
...
namespace Abzal_s.StudentsDataSetTableAdapters {
    ...
    public partial class tableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `table` WHERE ((`Имя` = ?) AND ((? = 1 AND `Язык` IS NULL) OR (`Язык`" +
                " = ?)) AND ((? = 1 AND `Возраст` IS NULL) OR (`Возраст` = ?)) AND ((? = 1 AND `К" +
                "атегория` IS NULL) OR (`Категория` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `table` (`Имя`, `Язык`, `Возраст`, `Категория`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `table` SET `Имя` = ?, `Язык` = ?, `Возраст` = ?, `Категория` = ? WHERE ((" +
                "`Имя` = ?) AND ((? = 1 AND `Язык` IS NULL) OR (`Язык` = ?)) AND ((? = 1 AND `Воз" +
                "раст` IS NULL) OR (`Возраст` = ?)) AND ((? = 1 AND `Категория` IS NULL) OR (`Кат" +
                "егория` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Abzal_s.Properties.Settings.Default.StudentsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Имя, Язык, Возраст, Категория FROM [table]";
        ...
        public virtual int Delete(string Original_Имя, string Original_Язык, global::System.Nullable<int> Original_Возраст, string Original_Категория) {
        ...
        public virtual int Insert(string Имя, string Язык, global::System.Nullable<int> Возраст, string Категория) {
            if ((Имя == null)) {
        ...
        public virtual int Update(string Имя, string Язык, global::System.Nullable<int> Возраст, string Категория, string Original_Имя, string Original_Язык, global::System.Nullable<int> Original_Возраст, string Original_Категория) {
            if ((Имя == null)) {
                throw new global::System.ArgumentNullException("Имя");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Язык, global::System.Nullable<int> Возраст, string Категория, string Original_Имя, string Original_Язык, global::System.Nullable<int> Original_Возраст, string Original_Категория) {
            return this.Update(Original_Имя, Язык, Возраст, Категория, Original_Имя, Original_Язык, Original_Возраст, Original_Категория);
        }
    }
